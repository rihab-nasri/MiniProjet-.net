...
namespace AM.Infrastructure.Migrations
{
    ...
    [Migration("20221103220940_ajoutTableStaffTraveller")]
    partial class ajoutTableStaffTraveller
    {
            ...
            modelBuilder.Entity("FlightPassenger", b =>
                {
                    ...
                    b.Property<string>("PassengerListPasseportNumber")
                        .HasColumnType("nvarchar(7)");

                    b.HasKey("FlightListFlightId", "PassengerListPasseportNumber");

                    b.HasIndex("PassengerListPasseportNumber");
            ...
            modelBuilder.Entity("FlightPassenger", b =>
                {
                    ...
                    b.HasOne("AM.ApplicationCore.Domain.Passenger", null)
                        .WithMany()
                        .HasForeignKey("PassengerListPasseportNumber")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
